...
PointContactSpec::PointContactSpec(RobotSystem* robot, 
    ...
    pnc_utils::pretty_constructor(3, "Point Contact Spec");
}
...
FixedBodyContactSpec::FixedBodyContactSpec(RobotSystem* _robot)
    ...
    pnc_utils::pretty_constructor(3, "Fixed Body Contact");
...
bool FixedBodyContactSpec::_UpdateJcQdot() {
    JcQdot_ = Eigen::VectorXd::Zero(dim_contact_);
    return true;
}
...
SurfaceContactSpec::SurfaceContactSpec(RobotSystem* robot, int _link_idx,
    ...
    pnc_utils::pretty_constructor(3, "Surface Contact Spec");
