...
KinWBC::KinWBC(const std::vector<bool>& act_joint)
    ...
    // threshold_(0.003)
{
    pnc_utils::pretty_constructor(3, "Kin WBC");
    ...
    // pnc_utils::pretty_print(act_jidx_, "act jidx");
...
bool KinWBC::FindConfiguration(const Eigen::VectorXd& curr_config,
    ...
    // //0112 pnc_utils::saveVector(delta_q, "delta_q0");
    // //0112 pnc_utils::saveVector(task->pos_err, "delta_x0");
    ...
    // pnc_utils::color_print(myColor::Red, "======== 0 ========");
    // Eigen::VectorXd xdot_c = Jc * delta_q;
    // pnc_utils::pretty_print(xdot_c, std::cout, "contact vel");
    // pnc_utils::pretty_print(Jt, std::cout, "task Jt");
    // pnc_utils::pretty_print(Jc, std::cout, "Jc");
    // pnc_utils::pretty_print(Nc, std::cout, "Nc");
    // pnc_utils::pretty_print(JtPre, std::cout, "JtNc");
    // pnc_utils::pretty_print(JtPre_pinv, std::cout, "JtPre_inv");
    // pnc_utils::pretty_print(task->pos_err, std::cout, "pos_err");
    // pnc_utils::pretty_print(task->vel_des, std::cout, "vel_des");
    // pnc_utils::pretty_print(delta_q, std::cout, "delta q");
    // pnc_utils::pretty_print(qdot, std::cout, "qdot");
    // pnc_utils::pretty_print(qddot, std::cout, "qddot");
    // Eigen::MatrixXd test = Jt * N_pre;
    // pnc_utils::pretty_print(test, std::cout, "Jt1N1");
    ...
    for (int i(1); i < task_list.size(); ++i) {
        ...
        // //0112 pnc_utils::saveVector(delta_q, "delta_q" + std::to_string(i));
        // //0112 pnc_utils::saveVector(task->pos_err, "delta_x" + std::to_string(i));

        // for(int j=0; j<JtPre_pinv.rows(); ++j)  {
        //     //0112 pnc_utils::saveVector(JtPre_pinv.row(j), "JtPre_pinv"+ std::to_string(i) );
        // }
        ...
        // pnc_utils::color_print(myColor::Red,
        //"======== " + std::to_string(i) + " ========");
        // pnc_utils::pretty_print(Jt, std::cout, "Jt");
        // pnc_utils::pretty_print(N_pre, std::cout, "N_pre");
        // pnc_utils::pretty_print(JtPre, std::cout, "JtPre");
        // pnc_utils::pretty_print(JtPre_pinv, std::cout, "JtPre_inv");
        // pnc_utils::pretty_print(task->pos_err, std::cout, "pos_err");
        // pnc_utils::pretty_print(task->vel_des, std::cout, "vel_des");
        // pnc_utils::pretty_print(delta_q, std::cout, "delta q");
...
void KinWBC::_PseudoInverse(const Eigen::MatrixXd J, Eigen::MatrixXd& Jinv) {
    pnc_utils::pseudoInverse(J, threshold_, Jinv);
