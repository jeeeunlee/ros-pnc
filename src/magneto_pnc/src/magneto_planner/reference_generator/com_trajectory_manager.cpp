...
void CoMTrajectoryManager::setCoMTrajectory(double _start_time,
  ...
  // pnc_utils::pretty_print(_motion_cmd.pa, std::cout, "com_pos_ini_");
  // pnc_utils::pretty_print(_motion_cmd.va, std::cout, "com_vel_ini_");
  ...
  if(_motion_cmd.is_acc_constant){
    ...
    pos_traj.initialize(_motion_cmd.pa, _motion_cmd.va, 
                        ...
                        traj_duration_);
    // pnc_utils::pretty_print(_motion_cmd.pb, std::cout, "com_pos_des_");
    // pnc_utils::pretty_print(_motion_cmd.vb, std::cout, "com_vel_des_");
  }
}
...
void CoMTrajectoryManager::updateCoMTrajectory(double current_time) {
  ...
  pnc_utils::saveVector(com_pos_des_, "com_pos_des_");
  pnc_utils::saveVector(com_vel_des_, "com_vel_des_");
  pnc_utils::saveVector(com_acc_des_, "com_acc_des_");
