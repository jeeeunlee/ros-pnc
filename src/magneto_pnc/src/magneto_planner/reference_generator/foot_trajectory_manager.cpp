...
void FootPosTrajectoryManager::updateFootPosTrajectory(const double& current_time) {
  ...
  //0112 pnc_utils::saveVector(foot_pos_des_, "foot_pos_des_");
  // //0112 pnc_utils::saveVector(foot_quat_des_, "foot_quat_des_");

  // pnc_utils::saveVector(foot_pos_des_, "foot_pos_des_");
  // pnc_utils::saveVector(foot_vel_des_, "foot_vel_des_");
  // pnc_utils::saveVector(foot_acc_des_, "foot_acc_des_");

  // pnc_utils::saveVector(foot_quat_des_, "foot_quat_des_");
  // pnc_utils::saveVector(foot_ori_vel_des_, "foot_ori_vel_des_");
  // pnc_utils::saveVector(foot_ori_acc_des_, "foot_ori_acc_des_");
