...
int main(int argc, char** argv) {
    ...
    try {
        ...
        pnc_utils::readParameter(simulation_cfg, "servo_rate", servo_rate);
        pnc_utils::readParameter(simulation_cfg, "is_record", isRecord);
        pnc_utils::readParameter(simulation_cfg, "show_joint_frame", b_show_joint_frame);
        pnc_utils::readParameter(simulation_cfg, "show_link_frame", b_show_link_frame);
        pnc_utils::readParameter(simulation_cfg, "ground", ground_file);
        pnc_utils::readParameter(simulation_cfg, "robot", robot_file);

        pnc_utils::readParameter(simulation_cfg, "initial_pose", q_floating_base_init);   
        pnc_utils::readParameter(simulation_cfg, "initial_leg_config", q_leg_init);          
    ...
    // pnc_utils::pretty_print(q_floating_base_init, std::cout, "q_floating_base_init");    

    // =========================================================================
    // Generate world and add skeletons
    // =========================================================================
    std::cout<<"Generate world and add skeletons"<<std::endl;
    ...
    // =========================================================================
    std::cout<<"Display Joints Frame"<<std::endl;
    ...
    // Enabel Joit Limits
    // =========================================================================
    std::cout<<"Enabel Joit Limits"<<std::endl;
    ...
    // Wrap a worldnode
    // =========================================================================
    std::cout<<"Wrap a worldnode"<<std::endl;
    ...
    // =========================================================================
    std::cout<<"Create and Set Viewer"<<std::endl;
